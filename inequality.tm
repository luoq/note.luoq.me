...
<\body>
  <screens|<\shown>
    ...
    <math|<big|sum><rsub|i<neg|=>j,i+j is
    even>a<rsub|i>*a<rsub|j>\<leqslant\>><math|<big|sum><rsub|i<neg|=>j,i+j
    ...
    <math|x<rsub|i>=a<rsub|i>/<around*|(|a<rsub|i>+b<rsub|i>|)>>, we prove
    the result.
    ...
    <math|<frac|1|2<rsup|k+1>><around*|(|m*A+d*A|)>\<leqslant\><around*|(|<frac|1|2<rsup|k+1>><around*|(|m*N<rsup|n>+d*A<rsup|n>|)>|)><rsup|1/n>\<Longleftrightarrow\>A<rsup|n>\<leqslant\><frac|m|2<rsup|k+1>>*N<rsup|n>+<frac|d|2<rsup|k+1>>A<rsup|n>\<Longleftrightarrow\>A<rsup|n>\<leqslant\>N<rsup|n>\<Longleftrightarrow\>A\<leqslant\>N>
    ...
    (b) Let <math|D=1,b\<rightarrow\>b*i,\<beta\>\<rightarrow\>-\<beta\>*i>,
    we have <math|<around*|(|a<rsup|2>+b<rsup|2>|)>*<around*|(|\<alpha\><rsup|2>+\<beta\><rsup|2>|)>=<around*|(|a*\<alpha\>+b*\<beta\>|)><rsup|2>-<around*|(|-a*\<beta\>*i+b*\<alpha\>*i|)><rsup|2>=<around*|(|a*\<alpha\>+b*\<beta\>|)><rsup|2>+<around*|(|a*\<beta\>-b*\<alpha\>|)><rsup|2>>
    ...
    From example, <math|D<rsub|n><rsup|<around*|(|3|)>>\<geqslant\>0> not
    hold generally
...
<\auxiliary>
  <\collection>
    <\associate|toc>
      <with|par-left|<quote|6fn>|1.3(b) <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
